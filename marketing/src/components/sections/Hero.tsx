    ...
    <div className="mx-auto max-w-[1360px] px-5 sm:px-8 lg:px-12">
      <div className="grid items-end gap-10 lg:grid-cols-[1.35fr_0.65fr] lg:gap-16">
        <div>
          ...
          >
            <Github className="h-3.5 w-3.5" /> Now open source{' '}
        ...
        <div className="border-l border-[#17211d]/25 pl-6 lg:pb-2 lg:pl-8">
          <p className="max-w-md text-lg leading-8 text-[#4f5854]">
            Matters, clients, documents and deadlines in one focused workspace—with practical AI
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex h-12 items-center gap-2 bg-[#2457ff] px-6 text-sm font-semibold text-white transition-colors hover:bg-[#1946dd]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex h-12 items-center gap-2 border border-[#17211d]/30 px-6 text-sm font-semibold transition-colors hover:border-[#17211d]"
            >
              Explore the code
            </a>
          </div>
      ...
      <div className="mt-14 border border-[#17211d]/25 bg-[#dfe7ff] p-2 shadow-[12px_12px_0_#17211d] sm:mt-20 sm:p-3">
        <div className="flex h-8 items-center gap-1.5 border-b border-[#17211d]/15 px-2">
          ...
          <span className="ml-3 font-mono text-[10px] uppercase tracking-[0.12em] text-[#57605c]">
            Kourti workspace / Dashboard
          </span>
        </div>
        <img
          src={dashboardLight}
          alt="Kourti dashboard showing active matters, clients, documents, and activity"
      ...
      <div className="mt-10 grid border-y border-[#17211d]/20 sm:grid-cols-3">
        {[
          ...
          <div
            key={title}
            className={`py-6 sm:px-6 ${index > 0 ? 'border-t border-[#17211d]/20 sm:border-l sm:border-t-0' : ''}`}
          >
