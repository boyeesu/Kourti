  ...
  const changelog: ChangelogEntry[] = [
    ...
    },
    {
      ...
      changes: {
        ...
        improved: ['Better user onboarding experience', 'Enhanced documentation and guides'],
      },
    },
    {
      version: '0.7.0',
      ...
      changes: {
        ...
        improved: ['Dashboard performance optimizations', 'Better data visualization'],
      },
    },
    {
      version: '0.6.0',
      ...
      changes: {
        ...
        improved: ['Document organization and tagging', 'Search functionality across contracts'],
      },
    },
    {
      version: '0.5.0',
      ...
      changes: {
        ...
        improved: ['File upload performance', 'Document search capabilities'],
      },
    },
    {
      version: '0.4.0',
      ...
      changes: {
        ...
        improved: ['Case timeline visualization', 'Activity tracking'],
      },
    },
    {
      version: '0.3.0',
      ...
      changes: {
        ...
        improved: ['Client onboarding process', 'Data security and privacy controls'],
      },
    },
    {
      version: '0.2.0',
      ...
      changes: {
        ...
        improved: ['User interface consistency', 'Navigation and routing'],
      },
    },
    {
      version: '0.1.0',
      ...
      <Card className="shadow-sm bg-muted/30">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['added', 'improved', 'fixed', 'changed', 'deprecated', 'removed', 'security'].map(
              (type) => {
                const { icon: Icon, color, bg, label } = getChangeTypeInfo(type);
                return (
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                This changelog is updated with every release. Check back regularly to see what's
                new, or subscribe to our newsletter to get updates delivered to your inbox.
              </p>
            </div>
          </div>
        </CardContent>
