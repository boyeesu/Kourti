...
export default function CaseCreate() {
  ...
  const lastMatterType =
    typeof window !== 'undefined' ? localStorage.getItem('last_matter_type') : '';
                        ...
                        <FormControl>
                          ...
                          >
                            <SelectTrigger>
                              <SelectValue
                                placeholder={
                                  isLoadingCaseIssues ? 'Loading issues...' : 'Select matter issue'
                                }
                              />
                            </SelectTrigger>
                            <SelectContent>
                              {isLoadingCaseIssues ? (
                                ...
                                <SelectItem value="none" disabled>
                                  No issues available for this matter type
                                </SelectItem>
                              )}
                            </SelectContent>
                          </Select>
