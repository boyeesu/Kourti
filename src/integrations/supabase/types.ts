  ...
  public: {
    ...
    Functions: {
      ...
      toggle_organization_status: {
        Args: { p_is_active: boolean; p_org_id: string };
        Returns: Json;
      };
      toggle_user_status: {
    ...
    Enums: {
      user_role: 'superadmin' | 'admin' | 'user' | 'finance' | 'administrator' | 'legal';
    };
    CompositeTypes: {
      [_ in never]: never;
    };
