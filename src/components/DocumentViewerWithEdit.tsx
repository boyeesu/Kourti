...
export function DocumentViewerWithEdit({
  open,
  onOpenChange,
  document,
  onUpdate,
}: DocumentViewerWithEditProps) {
        ...
        >
          ...
          <TabsContent value="view" className="flex-1 overflow-auto mt-4">
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: sanitizeHTML(document.content) || 'No content available',
              }}
            />
          </TabsContent>
          ...
          <TabsContent value="edit" className="flex-1 overflow-auto mt-4">
            <div className="space-y-4">
              <RichTextEditor content={editedContent} onChange={setEditedContent} editable={true} />
